...
\usepackage{makeidx} 
\makeindex
% Används för att kunna köra \makeindex make index ser till att alla sidnummer blir korrekta i innehållsförtäckning vid första % kompilering. Annars måste man kompilera två gånger när sidnummer ändras för att få det rätt sidnummer i 
